...
import { AIR_SCALE, outOfScale } from '../src/oxygen.mjs'
import { log, logEvent } from '../src/logger.mjs'
import { config } from '../src/config.mjs'
import { announceHazard } from '../src/comms.mjs'
import { isNight, snapshot, inventorySummary } from '../src/state.mjs'
import { breathable, makeAirClock, airEmergency } from '../src/air.mjs'
import { dropsOf } from '../src/drops.mjs'
import { harvestSafe, stairUpStep, chooseStairUpBearing, headroomBreach,
         bodyPassable, isFallingBlock, supportProbablyReal, restingOnBoundary } from '../src/scaffold.mjs'
import { planDig, predictedDigMs, digHand, digEnv, planDigSplit, escapeDigPlan } from '../src/digbudget.mjs'
import { mayHarvestUnderfoot, settleForFall, FALL_SETTLE_MS, FALL_POLL_MS } from '../src/mining.mjs'
import { climbLadder, bestLadderWall, ladderPlan } from '../src/ladder.mjs'
import { escapePlan, ESCAPES } from '../src/escape.mjs'
import { scoopLeavesAir, isWaterSource } from '../src/bucket.mjs'
