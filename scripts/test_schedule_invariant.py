...
if not os.path.exists(LOOP):
    ...
    # The host runs ~/v30check.py; a developer machine has only the repo copy. Defaulting to the
    # home path alone made this case fail off-host for an environmental reason, which is how a
    # suite teaches people to ignore a red line. Env override, then the repo copy beside this
    # test, then the host path.
